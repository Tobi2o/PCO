/**
 * @file utils.cpp
 * @brief En-tête pour les fonctions utilitaires modifiées du système de simulation.
 * - Se  situe normalement danns le .h mais exceptionnellement ici pour ce laboratoire.
 * @date 2023-11-08
 * @author Christen Anthony, Harun Ouweis
 *
 * Historique des modifications :
 * - Ajout de la méthode `endService` pour demander l'arrêt des threads de manière propre.
 */

#include "utils.h"

// Dans la méthode `endService`, ajout d'une boucle pour arrêter les threads de manière propre.
